...
<!--
write_setting_menu(MENU_ID_FRIENDLY_NAME, "<% aspGetCneVal("/cfg/Pioneer/State","Destination", "0"); %>", "<% aspCheckIfWired(-1); %>", "<% aspGetCneVal("/cfg/Networking/JBCONNECT","Enabled", "0"); %>", "<% aspGetInputInformationEx(); %>");
//-->
</script></td><td valign="top" align="left"><script type="text/javascript">
<!--
write_result("img/12AV_WebCon_PC_047.gif", false);
//-->
